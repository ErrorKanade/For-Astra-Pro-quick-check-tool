...
操作系统: Windows 10/11Python: 3.10+ (需与 SDK 位数一致，建议 64-bit)依赖库:Bashpip install numpy opencv-python openni
🚀 快速开始1. SDK 准备由于本程序调用了底层 C++ 库，需要准备好 Orbbec 官方的 OpenNI 2.3 SDK。
...
⚠️ 常见问题排查 (Troubleshooting)无法检测到 RGB 相机？Astra Pro 的彩色摄像头通常占用系统视频索引 0, 1 或 2。若未显示，请尝试修改代码中的：cap_rgb = cv2.VideoCapture(2, cv2.CAP_DSHOW)。
